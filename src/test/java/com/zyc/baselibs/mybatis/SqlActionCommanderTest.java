...
public class SqlActionCommanderTest {
	...
	public void selectByPageTest() {
		...
		param.put(SqlScriptProviderSupport.PKEY_ENTITY, test);
		
		param.put(SqlScriptProviderSupport.PKEY_PAGINATION, new Pagination(0, 0, null, false));
		String sql = commander.selectByPage(param);
		System.out.println(sql);
		assertEquals(sql.contains("limit 1,20"), true);
		
		param.put(SqlScriptProviderSupport.PKEY_PAGINATION, new Pagination(0, 1, null, false));
		sql = commander.selectByPage(param);
		System.out.println(sql);
		assertEquals(sql.contains("limit 1,1"), true);
		
		param.put(SqlScriptProviderSupport.PKEY_PAGINATION, new Pagination(1, 0, null, false));
		sql = commander.selectByPage(param);
		System.out.println(sql);
		assertEquals(sql.contains("limit 1,20"), true);
		
		param.put(SqlScriptProviderSupport.PKEY_PAGINATION, new Pagination(1, 1, "name", true));
		sql = commander.selectByPage(param);
		sql = commander.selectByPage(param);
		System.out.println(sql);
	...
	public void loadTest() {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put(SqlScriptProviderSupport.PKEY_ID, "a");
		
		param.put(SqlScriptProviderSupport.PKEY_CLASS, _Test.class);
